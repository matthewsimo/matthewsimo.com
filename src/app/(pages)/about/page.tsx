  ...
  return (
    <article className={`${gridClass}`}>
      <div className="space-y-6 pb-10">
        ...
        <p>
          Hi there, I&apos;m Matthew - I fight for the user. I&apos;m a born and
          raised Texan and have been building things for the web for fifteen
          years.
        </p>
      ...
      <div className="space-y-6 pb-10">
        ...
        <p>
          ...
          and IP, here is a small, curated list. You can see a list of selected{" "}
          <Link href="/projects">projects over here</Link>.
        </p>
      ...
      <div className="space-y-6 pb-10">
        ...
        <p>
          ...
          <strong className="font-semibold">low-maintenance</strong>. I want to
          maintain a low level of complexity and keep the number of technologies
          to a minimum. Another goal is that this site acts as a creative outlet
          for self expressions and I don&apos;t know where I want to take things
          in the future so I don&apos;t want to limit creativity or
          possibilities. Since I&apos;ve got other stuff higher on my priority
          list, I need things to &quot;just work&quot; with as little tinkering
          as possible &mdash; I want to write and experiment not fiddle with a
          site that is supposed to allow me to write and experiment.
        </p>
        <p>
        ...
        <p>
          I&apos;ve opted to keep dependencies that need to load to a minimum so
          I&apos;m having <Link href="https://rsms.me/inter/">Inter</Link>
